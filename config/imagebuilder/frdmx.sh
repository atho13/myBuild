...
rebuild_firmware() {
    ...
    echo -e "${STEPS} Mengatur konfigurasi ukuran partisi (768MB)..."
    ...
    my_packages="-dnsmasq dnsmasq-full base-files dropbear e2fsprogs firewall4 fstools tc-full \
          ...
          kmod-usb-net-cdc-ncm kmod-usb-net-cdc-mbim luci-proto-modemmanager modemmanager modemmanager-rpcd qmi-utils \
          libqmi libmbim glib2 ipset libcap libcap-bin ruby ruby-yaml kmod-inet-diag kmod-nft-tproxy mbim-utils sms-tool \
          ...
          luci-app-ttyd luci-theme-material iw iwinfo vnstat2 vnstati2 php8-mod-mbstring php8-cli \
