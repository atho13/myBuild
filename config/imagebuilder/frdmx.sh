...
download_imagebuilder() {
    cd "${make_path}"
    echo -e "${STEPS} Mengunduh ImageBuilder OpenWrt 24.10.5 (ARMSR/ARMV8)..."
    # echo -e "${STEPS} Mengunduh ImageBuilder ImmortalWrt 24.10.6 (ARMSR/ARMV8)..."
    
    URL="https://downloads.openwrt.org/releases/24.10.5/targets/armsr/armv8/openwrt-imagebuilder-24.10.5-armsr-armv8.Linux-x86_64.tar.zst"
