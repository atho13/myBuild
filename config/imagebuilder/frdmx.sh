...
download_imagebuilder() {
    ...
    URL="https://downloads.immortalwrt.org/releases/24.10.6/targets/armsr/armv8/immortalwrt-imagebuilder-24.10.6-armsr-armv8.Linux-x86_64.tar.zstx_tr_hl=id&_x_tr_pto=tc"
